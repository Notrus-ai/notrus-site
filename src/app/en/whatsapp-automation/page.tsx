  ...
  const benefits = [
    {
      ...
      title: "24/7 Support",
      description:
        "Your customers are served anytime, even outside business hours",
    },
    {
      icon: Users,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-green-100">
                Our AI automatically replies on WhatsApp, integrates with your
                CRM/ERP and reduces costs while boosting customer satisfaction.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your customer service with cutting-edge technology that
              really works
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Our platform provides complete tools to automate and optimize
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Over 500 companies have already automated their customer service
              with us
            </p>
          </div>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <blockquote className="text-gray-600 mb-4">
                  We reduced customer service costs by 60% and increased
