...
const ISPAutomacaoPage = () => {
    ...
    const useCases = [
        {
            ...
            description: 'Automatic diagnostics integrated with NOC/DownDetector and guided troubleshooting to solve connectivity issues without human intervention.',
            conversation: {
        ...
        },
        {
            ...
            description: 'Smart rescheduling based on availability, location, and priority, optimizing routes and reducing operational costs.',
            conversation: {
        ...
        },
        {
            ...
            description: 'Automatic invoice issuance, instant PIX payment, and smart delinquency negotiation, reducing cancellations due to financial issues.',
            conversation: {
        ...
        },
        {
            ...
            description: 'Proactive offers for customers at risk of cancellation, based on behavioral analysis and service history.',
            conversation: {
        ...
        },
        {
            ...
            description: 'Instant package contracting or speed increase with automatic activation and real-time confirmation.',
            conversation: {
        ...
        },
        {
            ...
            description: 'Remote diagnostics, equipment configuration, and technical troubleshooting directly integrated with monitoring systems.',
            conversation: {
    ...
    const benefits = [
        {
            ...
            description: 'Reduce up to 80% of calls to your support center with automatic resolution of common issues, freeing your team for complex cases.'
        },
        {
            icon: '💰',
            title: 'More Customers Retained',
            description: 'Proactive retention identifies at-risk customers and offers solutions before cancellation, significantly reducing voluntary churn.'
        },
        {
            icon: '⚡',
            title: 'Instant Resolution',
            description: 'Automatic diagnostics and real-time troubleshooting, directly integrated with your monitoring systems.'
        },
        {
            icon: '📈',
            title: 'Automated Sales',
            description: 'Upgrades and new services offered at the right moment, increasing ARPU with no additional effort from your sales team.'
        },
        {
            icon: '🎯',
            title: 'Operational Efficiency',
            description: 'Automatic scheduling, reminders, and optimized technical routes significantly reduce operational costs.'
        },
        {
            icon: '📊',
            title: 'Actionable Insights',
            description: 'Detailed reports on issue patterns, customer satisfaction, and opportunities for network and service improvement.'
        }
    ];
    ...
    const integrations = [
        ...
        { name: 'NOC/DownDetector', desc: 'Real-time network monitoring', logo: 'NOC' },
            ...
            <section className="bg-gradient-to-br from-purple-600 via-purple-500 to-purple-400 text-white py-32 px-5 text-center relative overflow-hidden">
                <div className="max-w-4xl mx-auto relative z-10">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                        The AI that helps ISPs retain customers,<br />
                        boost CSAT and automate<br />
                        <span className="text-yellow-300">up to 80% of support requests</span>
                    </h1>
                    <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
                        Reduce calls, increase retention, and improve your subscribers’ experience — all directly on WhatsApp.
                    </p>
                    <Button
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-2xl p-8 notrus-shadow-lg">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-xl notrus-text-secondary">
                                See how Notrus can transform your ISP support
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm notrus-text-secondary mt-4">
                                    30 minutes demonstration • No commitment• Free consultancy
                                </p>
                            </div>
                        </form>
                    </div>
