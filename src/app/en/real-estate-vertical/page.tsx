  ...
  const testimonials = [
    {
      ...
      quote:
        "Automation allowed us to serve prospects 24/7. Our agents now focus only on visits and closings.",
    ...
    },
    {
      ...
      quote:
        "Automatic client follow-up revolutionized our operation. Nobody is left without an answer.",
    ...
    },
    {
      ...
      quote:
        "From the first visit to key delivery, everything is tracked automatically. Clients love it!",
      author: "Paulo Mendes",
      position: "CEO",
  ...
  const useCases = [
    {
      ...
      automation:
        "AI qualifies the profile, sends floor plans, and schedules a visit automatically",
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-orange-100">
                From lead capture to key delivery, our real estate-specialized
                AI automates the entire sales and after-sales process.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-white hover:bg-orange-600 text-orange-600 hover:text-white"
                  aira-label="See how it works for your company"
                >
