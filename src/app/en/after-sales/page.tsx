    ...
    const useCases = [
        {
            ...
            example: '"Your order #1234 is out for delivery and will arrive in 2 hours"'
        },
        {
            icon: Shield,
    ...
    const testimonials = [
        {
            ...
            quote: 'Our customers love receiving automatic updates. It drastically reduced support calls.',
        ...
        },
        {
            ...
            quote: 'We automated the entire after-sales follow-up. Customers get reminders for inspections, documentation, and more.',
        ...
        },
        {
            ...
            quote: 'Technical issues are resolved faster with automatic diagnostics via WhatsApp.',
            author: 'Ana Santos',
        ...
        <div className="min-h-screen">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl mb-8 text-purple-100">
                                Automate your entire after-sales with smart updates on orders, warranty, rescheduling, and more via WhatsApp.
                            </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-600 mb-8">
                                Our platform connects with major market systems to automate the entire after-sales workflow.
                            </p>

                            <div className="space-y-4">
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                                    <span className="text-gray-700">E-commerce Integration (Shopify, WooCommerce, Magento)</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                                    <span className="text-gray-700">CRM Connection (Salesforce, HubSpot, Pipedrive)</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                                    <span className="text-gray-700">Carrier APIs (Correios, Loggi, Total Express)</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                                    <span className="text-gray-700">Management Systems (ERP, WMS, OMS)</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative">
            ...
            <section className="py-20 bg-purple-600 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl mb-8 text-purple-100">
                        Try it free for 14 days and see how your customers get more satisfied
                    </p>
