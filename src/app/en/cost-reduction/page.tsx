    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100">
                Compare the costs of traditional service with our intelligent
                automation and find out how much your company can save.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-white text-blue-600 hover:bg-blue-600 hover:text-white"
                  aria-label="Calculate your savings now"
                >
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Talk to our experts and discover how to save up to R${" "}
          ...
          <Card className="max-w-md mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                aria-label="Calculate personalized savings"
              >
