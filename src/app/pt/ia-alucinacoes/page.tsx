...
const AIHallucinationsArticlePT: React.FC = () => {
  ...
  const pageDescription =
    ...
    "Insights sobre alucinações de IA e confiabilidade em 2025.";
        ...
        <section className="relative overflow-hidden">
          <div className="mx-auto max-w-4xl px-6 pt-14 pb-8 md:pt-20">
            ...
            <figure className="mt-6 mb-2 mx-auto w-full max-w-md overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
              <Image
                src="/4-1-pt.png"
                alt="Visualização de alucinações de IA"
                width={960}
                height={540}
          ...
          <section className="mb-14">
            ...
            {texts.s1FigureCaption?.trim() ? (
              <figure className="mt-8 mb-4 mx-auto w-full max-w-lg overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <Image
                  src="/4-2-pt.png"
                  alt="Tipos de alucinações de IA"
                  width={960}
                  height={540}
                  className="w-full h-auto object-contain bg-white"
                  priority={false}
          ...
          <section className="mb-14">
            ...
            {texts.s2FigureCaption?.trim() ? (
              <figure className="mt-8 mb-4 mx-auto w-full max-w-lg overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <Image
                  src="/4-3-pt.png"
                  alt="Comparação de desempenho de LLMs"
                  width={960}
                  height={540}
                  className="w-full h-auto object-contain bg-white"
                  priority={false}
            ...
            <div className="mb-8">
              ...
              {texts.s4HybridFigureCaption?.trim() ? (
                <figure className="mt-8 mb-4 mx-auto w-full max-w-lg overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                  <Image
                    src="/4-4-pt.png"
                    alt="Pipelines híbridos de confiabilidade de IA"
                    width={960}
                    height={540}
                    className="w-full h-auto object-contain bg-white"
                    priority={false}
...
export default AIHallucinationsArticlePT;
