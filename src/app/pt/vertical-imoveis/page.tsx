  ...
  const testimonials = [
    {
      ...
      quote:
        "A automação nos permitiu atender interessados 24h por dia. Nossos corretores agora focam apenas em visitas e fechamentos.",
    ...
    },
    {
      ...
      quote:
        "O acompanhamento automático dos clientes revolucionou nossa operação. Ninguém mais fica sem resposta.",
    ...
    },
    {
      ...
      quote:
        "Desde a primeira visita até a entrega das chaves, tudo é acompanhado automaticamente. Clientes adoram!",
      author: "Paulo Mendes",
      position: "CEO",
  ...
  const useCases = [
    {
      ...
      automation:
        "IA qualifica o perfil, envia plantas e agenda visita automaticamente",
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-orange-100">
                Da captação de leads até a entrega das chaves, nossa IA
                especializada em imobiliário automatiza todo o processo de
                vendas e pós-venda.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-white hover:bg-orange-600 text-orange-600 hover:text-white"
                  area-label="Veja como funciona para sua empresa"
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-orange-600 hover:bg-orange-600 hover:text-white"
                  area-label="Agende uma demonstração"
                >
