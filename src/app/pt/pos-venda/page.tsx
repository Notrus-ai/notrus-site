...
export default function PosVenda() {
  const useCases = [
    ...
    },
    {
      ...
      example:
        '"Sua garantia vence em 30 dias. Precisa de ajuda com algum problema?"',
    },
    {
      icon: Calendar,
      title: "Reagendamento",
  ...
  const testimonials = [
    {
      ...
      quote:
        "Nossos clientes adoram receber atualizações automáticas. Reduziu drasticamente as ligações para o SAC.",
    ...
    },
    {
      ...
      quote:
        "Automatizamos todo o acompanhamento pós-venda. Clientes recebem lembretes de vistoria, documentação e muito mais.",
    ...
    },
    {
      ...
      quote:
        "Problemas técnicos são resolvidos mais rápido com diagnósticos automáticos via WhatsApp.",
      author: "Ana Santos",
    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-purple-100">
                Automatize todo o pós-venda com atualizações inteligentes sobre
                pedidos, garantia, reagendamentos e muito mais via WhatsApp.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-white text-purple-600 hover:bg-purple-600 hover:text-white"
                  aria-label="Teste grátis no WhatsApp"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Nossa plataforma se conecta com os principais sistemas do
                mercado para automatizar todo o fluxo de pós-venda.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                  <span className="text-gray-700">
                    Conexão com CRM (Salesforce, HubSpot, Pipedrive)
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                  <span className="text-gray-700">
                    APIs de transportadoras (Correios, Loggi, Total Express)
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0" />
                  <span className="text-gray-700">
                    Sistemas de gestão (ERP, WMS, OMS)
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-purple-100">
            Teste gratuitamente por 14 dias e veja como seus clientes ficam mais
            satisfeitos
          </p>
