  ...
  const benefits = [
    {
      ...
      description:
        "Seus clientes são atendidos a qualquer hora, mesmo fora do horário comercial",
    },
    {
      icon: Users,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-green-100">
                Nossa IA responde automaticamente no WhatsApp, integra com seu
                CRM/ERP e reduz custos enquanto aumenta a satisfação dos
                clientes.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  aria-label="Agende uma demo grátis"
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-green-600 hover:bg-green-600 hover:text-white"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transforme seu atendimento com tecnologia de ponta que realmente
              funciona
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Nossa plataforma oferece recursos completos para automatizar e
                otimizar seu atendimento no WhatsApp.
              </p>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <blockquote className="text-gray-600 mb-4">
                  Reduzimos 60% dos custos de atendimento e aumentamos a
