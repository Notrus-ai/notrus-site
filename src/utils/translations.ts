...
export const translations = {
  en: {
    ...
    floatingNewsletterSubtitle: 'Stay up to date with the latest in AI',
    floatingNewsletterButton: 'Subscribe',
    floatingNewsletterPlaceholder: 'Your email address',
    floatingNewsletterSuccess: 'Thank you for subscribing!',
    floatingNewsletterError: 'An error occurred. Please try again.',
    floatingNewsletterSending: 'Sending...',
    floatingNewsletterClose: 'Close newsletter',
    contact: 'contact',
    product: 'product',
    benefits: 'benefits',
    security: 'security',
    ...
    panel4LabelText: '$45.230',
    metricsTitle: 'Results that scale with your operation',
  ...
  pt: {
    floatingNewsletterTitle: 'Receba insights exclusivos',
    floatingNewsletterSubtitle: 'Fique por dentro das últimas novidades em IA',
    floatingNewsletterButton: 'Inscrever-se',
    floatingNewsletterPlaceholder: 'Seu endereço de e-mail',
    floatingNewsletterSuccess: 'Obrigado por se inscrever!',
    floatingNewsletterError: 'Ocorreu um erro. Tente novamente.',
    floatingNewsletterSending: 'Enviando...',
    floatingNewsletterClose: 'Fechar newsletter',
    contact: 'contato',
    product: 'produto',
    benefits: 'beneficios',
    security: 'seguranca',
    ...
    panel4LabelText: 'R$45.230',
    metricsTitle: 'Resultados que escalam com a sua operação',
...
export const contactFormTranslations = {
  pt: {
    ...
    message: "Mensagem",
    mainCountries: "PRINCIPAIS PAÍSES",
    otherCountries: "OUTROS PAÍSES",
    searchCountry: "Pesquisar país...",
    monthlyTickets: "Ticket mensais de suporte",
    selectOptions: "Selecione uma opção",
    messagePlaceholder: "Conte-nos sobre suas necessidades...",
    sendMessage: "Enviar mensagem",
    sending: "Enviando...",
    messageSent: "Mensagem enviada com sucesso!",
    contactResponse: "Nossa equipe entrará em contato em breve.",
    whatsappDirect: "Ou converse diretamente pelo WhatsApp",
...
{message}`
  ...
  en: {
    ...
    monthlyTickets: "Monthly support tickets",
    selectOptions: "Select an option",
    messagePlaceholder: "Please let us know your requirements...",
    sendMessage: "Send message",
    sending: "Sending...",
    messageSent: "Message sent successfully!",
    contactResponse: "Our team will be in touch shortly.",
    whatsappDirect: "Or chat directly via WhatsApp",
...
export interface ResourcesTexts {
  heroTitle: string;
  heroSubtitle: string;
  locale: string;
  categories: {
...
export const resourcesTexts: Record<Language, ResourcesTexts> = {
  en: {
    heroTitle: "Resources",
    heroSubtitle:
      "Stay up to date with the latest insights, news, and content from Notrus.",
    locale: "en-US",
    categories: {
      product: "Product",
      insights: "Insights",
    ...
    resources: {
      resource1Title: "Stop Losing Customers: 7 Data-Backed Ways AI Converts Service into Loyalty",
      resource1Description:
        "Bad service destroys around $3.5T annually. Use these AI-backed moves to lift satisfaction, speed, and retention across the customer journey.",

      resource2Title: "Behind Every Polite Voice: How AI Cuts Burnout by 40% and Builds Better Agents",
      ...
      resource5Description:
        "Deep dive into how Orbit processes payments, refunds, and returns with total security and efficiency.",

      resource6Title: "From Support to Revenue: The AI Opportunity",
      resource6Description:
        "How AI-powered customer experience drives 25% revenue growth through better conversion and upsells.",
    },
    readMore: "Read more",
    ctaTitle: "Ready to Transform Your Customer Operations?",
    ctaDescription:
      "Join the market leaders who trust Notrus to run their customer operations at enterprise scale",
  ...
  pt: {
    heroTitle: "Insights",
    heroSubtitle:
      "Mantenha-se atualizado com os últimos insights, notícias e conteúdos da Notrus.",
    locale: "pt-BR",
    categories: {
      product: "Produto",
      insights: "Insights",
    ...
    resources: {
      resource1Title: "Pare de perder clientes: 7 formas comprovadas de como a IA transforma serviço em lealdade",
      resource1Description:
        "Mau atendimento destrói cerca de US$ 3,5 trilhões por ano. Use essas ações com IA para elevar satisfação, agilidade e retenção em toda a jornada do cliente.",

      resource2Title: "Por trás de cada voz educada: como a IA reduz o burnout em 40% e forma agentes melhores",
      resource2Description:
      ...
      resource5Description:
        "Mergulhe em como o Orbit processa pagamentos, reembolsos e devoluções com total segurança e eficiência.",

      resource6Title: "De Suporte a Receita: A Oportunidade com IA",
      resource6Description:
        "Como a experiência do cliente com IA impulsiona 25% de crescimento de receita através de melhor conversão e upsells.",
    },
    readMore: "Leia mais",
    ctaTitle: "Pronto para Transformar suas Operações de Atendimento?",
    ctaDescription:
      "Junte-se aos líderes de mercado que confiam na Notrus para gerenciar suas operações de atendimento em escala empresarial",
    ctaButton: "Agendar uma demo",
  },
};

export type ArticleTexts = typeof articleTexts["en"];
...
export const articleTexts = {
  en: {
    ...
    editorialTitle: "AI-powered Service → Loyalty: Notrus Editorial Rev 1 (Oct 2025)",
    contentType: "Article",
    date: "October 2025",
    ...
    seoTitle:
      "Stop Losing Customers: 7 Data-Backed Ways AI Converts Service into Loyalty",
    metaDescription:
      "Bad service destroys around $3.5T annually. Use these AI-backed moves to lift satisfaction, speed, and retention across the customer journey.",
    byline: "Researched and Written by: Felipe Gomez @ Notrus AI",
    linkedinHookLong:
      "Bad service isn’t just annoying—it’s an economy-sized mistake. By 2024 estimates, poor service risked around $3.5 trillion in global losses. Here are seven AI plays that turn support from cost center to loyalty engine.",
    heroTitle:
      "Stop Losing Customers: 7 Data-Backed Ways AI Converts Service into Loyalty",

    tldrTitle: "TL;DR (Key Takeaways)",
    tldrPoints: [
      "Global cost of poor service: around $3.5T (2024) → urgency to act.",
    ...
    pullQuote: "Efficiency attracts customers; satisfaction keeps them.",

    whyNowTitle: "Why this matters now",
    whyNowBody:
      "Poor customer service cost companies around $3.5 trillion in 2024 (Qualtrics XM Institute, 2024) annually. The takeaway isn’t just “go faster.” It’s to make service feel better—predictive, consistent, and human in all the right ways. In a hyper-competitive market, support is no longer reactive overhead; it’s a strategic driver of retention, revenue, and advocacy.\n\nStudies show that AI-enabled support meaningfully increases both customer satisfaction and perceived efficiency, which together drive stronger loyalty. Recent research <a href=\"https://www.tandfonline.com/doi/full/10.1080/23311975.2024.2326107/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 hover:text-blue-800 hover:underline font-medium\">(Singh & Singh, 2024; Hussain et al., 2025)</a> highlights that while AI enhances both factors, satisfaction remains the primary engine of loyalty, with efficiency serving as a valuable enabler. In short, AI builds loyalty not merely through faster service, but by elevating the overall customer experience.",

    metricsTitle: "Metrics that change behavior (and where to use them)",
    metricsPoints: [
      "First-contact resolution (FCR): Lift FCR by even a few points and you typically reduce repeat contacts and churn.",
      "Time-to-answer: Faster is table stakes; use AI to anticipate needs (proactive prompts, in-product tips) rather than only speed up replies.",
      "Self-service containment: High-quality, explainable self-serve raises satisfaction when paired with handoff control to humans.",
      "CSAT / NPS / CES: Track post-resolution outcomes and feed them into model retraining for closed-loop improvement.",
    ],

    cxFootprintTitle: "What the global CX footprint really suggests",
    cxFootprintIntro:
    ...
    sevenPlays: [
      {
        title: "Intent routing with confidence thresholds",
        body:
      ...
      {
        title: "Trusted, up-to-date answers with citations",
        body:
      ...
      {
        title: "Proactive service & anomaly alerts",
        body:
      ...
      {
        title: "Contextual Next Step for loyalty",
        body:
      ...
      {
        title: "Safety, guardrails, and escalation design",
        body:
      ...
      {
        title: "Closed-loop learning with human feedback",
        body:
          "Tag each interaction with outcome labels (resolved/unresolved, effort, sentiment). Retrain regularly; publish win stories to sustain momentum.",
      },
    ],

    goodFeelsTitle: "What “good” feels like to customers",
    goodFeelsPoints: [
    ...
    conclusionTitle: "Conclusion: Lead the AI loyalty revolution",
    conclusionBody:
    ...
    references: {
      ahmad2022:
        "Ahmad, S., Karim, S., & Shaikh, A. (2022). The impact of artificial intelligence on customer experience: Evidence from service industries. Frontiers in Psychology, 13, 897851. DOI: 10.3389/fpsyg.2022.897851.",
      chen2024:
        "Chen, Y., & Prentice, C. (2024). Integrating Artificial Intelligence and Customer Experience. Australasian Marketing Journal, 33(2), 141-153. DOI: 10.1177/14413582241252904.",
      hussain2025:
        "Hussain, M. A., Hussain, A., Rahman, M. A. U., Irfan, M., & Hussain, S. D. (2025). The effect of AI in fostering customer loyalty through efficiency and satisfaction. Advances in Consumer Research, 2(1), 331–340.",
      morgan2017:
        "Morgan, B. (2017, September 25). Customer service is a $350B industry, and it's a mess. Forbes.",
      qualtrics2024:
        "Qualtrics XM Institute. (2024, February 1). Bad customer service threatens $3.7 trillion annually as frontline workers reach a breaking point [Blog post].",
      sheth2023:
        "Sheth, J., et al. (2023). Rethinking customer engagement: The role of customer support in the digital age. Journal of Business Research, 160. DOI: 10.1016/j.jbusres.2023.113943.",
      singh2024:
        "Singh, A., & Singh, R. (2024). The power of AI: Enhancing customer loyalty through satisfaction and efficiency. Cogent Business & Management, 11(1), 2326107. DOI: 10.1080/23311975.2024.2326107.",
    },
  },
  ...
  pt: {
    locale: "pt-BR",
    metaType: "Artigo",
    metaDateOct2025: "Outubro 2025",

    editorialTitle: "Serviço com IA → Lealdade: Revisão Editorial Notrus 1 (Outubro 2025)",
    contentType: "Artigo",
    ...
    metaDescription:
      "Mau atendimento destrói cerca de US$ 3,5 trilhões por ano. Use essas ações com IA para elevar satisfação, agilidade e retenção em toda a jornada do cliente.",
    byline: "Pesquisado e escrito por: Felipe Gomez @ Notrus AI",
    linkedinHookLong:
      "Mau atendimento não é só irritante — é um erro de escala econômica. Em 2024, o custo global de um mau atendimento chegou a US$ 3,5 trilhões. Aqui estão sete estratégias com IA que transformam o suporte de centro de custo em motor de lealdade.",
    heroTitle:
      "Pare de perder clientes: 7 formas comprovadas de como a IA transforma serviço em lealdade",
    ...
    pullQuote: "Eficiência atrai clientes; satisfação os mantém.",

    whyNowTitle: "Por que isso importa agora",
    whyNowBody:
      "O mau atendimento ao cliente custou às empresas cerca de US$ 3,5 trilhões em 2024 (Qualtrics XM Institute, 2024). A lição não é apenas “seja mais rápido” — é fazer o serviço parecer melhor: preditivo, consistente e humano nos aspectos certos. Num mercado hipercompetitivo, o suporte deixou de ser um custo reativo e tornou-se um impulsionador estratégico de retenção, receita e advocacia.\n\nPesquisas mostram que o suporte com IA aumenta significativamente tanto a satisfação quanto a eficiência percebida, e juntas elas fortalecem a lealdade. Estudos recentes <a href=\"https://www.tandfonline.com/doi/full/10.1080/23311975.2024.2326107/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-blue-600 hover:text-blue-800 hover:underline font-medium\">(Singh & Singh, 2024; Hussain et al., 2025)</a> destacam que, embora a IA melhore ambos os fatores, a satisfação continua sendo o principal motor da lealdade — e a eficiência, um facilitador valioso. Em resumo: a IA constrói lealdade não apenas com rapidez, mas aprimorando toda a experiência do cliente.",

    metricsTitle: "Métricas que mudam comportamento (e onde aplicá-las)",
    metricsPoints: [
      "Resolução no primeiro contato (FCR): aumentar mesmo poucos pontos reduz contatos repetidos e churn.",
      "Tempo de resposta: rapidez é o básico; use IA para antecipar necessidades (dicas proativas, sugestões no produto), não apenas responder mais rápido.",
      "Taxa de autosserviço: autosserviço de qualidade, com explicações e controle de transferência para humanos, eleva a satisfação.",
      "CSAT / NPS / CES: acompanhe resultados pós-resolução e alimente o re-treinamento dos modelos — criando um ciclo de melhoria contínua.",
    ],

    cxFootprintTitle: "O que o panorama global de CX realmente revela",
    cxFootprintIntro:
    ...
    sevenPlays: [
      {
        title: "Roteamento de intenção com limiares de confiança",
        body:
      ...
      {
        title: "Respostas confiáveis e atualizadas com citações",
        body:
      ...
      {
        title: "Serviço proativo e alertas de anomalias",
        body:
      ...
      {
        title: "Próximo passo contextual para lealdade",
        body:
      ...
      {
        title: "Aprendizado em ciclo fechado com feedback humano",
        body:
    ...
    goodFeelsTitle: "O que é “bom” sob a ótica do cliente",
    goodFeelsPoints: [
    ...
    conclusionTitle: "Conclusão: lidere a revolução da lealdade com IA",
    conclusionBody:
...
export type Article2Texts = typeof article2Texts["en"];

export const article2Texts = {
  en: {
    locale: "en-US",
    slug: "behind-every-polite-voice",
    metaType: "Article",
    metaDateOct2025: "October 14, 2025",
    author: "Research and Writing by: Felipe Gomez @ Notrus AI",
    keywords: [
    ...
    heroTitle: "Behind Every Polite Voice: How AI Cuts Burnout by 40% and Builds Better Agents",
    byline: "Visuals by Notrus AI",

    tldrTitle: "TL;DR (Key Takeaways)",
    tldrBullets: [
      "Behind every polite voice, 87% of agents are fighting stress.",
    ...
    whyItMattersBullets: [
      "Burnout shows up as absenteeism and churn—both expensive.",
      "Supportive AI reduces cognitive load and speeds learning.",
      "Surveillance-heavy AI raises stress and erodes trust.",
    ],
    ...
    s1Figure1Caption:
      "Usual operational stressors that combine to create a persistent mental load in call centers: Source: Doellgast and O’Braddy (2020). Visuals by Notrus AI.",
    s1Figure2Caption: "Visuals by Notrus AI",
    ...
    brRegTitle: "Conclusion: Turning Turnover into Breakthrough",
    brRegBody: [
  ...
  pt: {
    locale: "pt-BR",
    slug: "por-tras-de-cada-voz-educada",
    metaType: "Artigo",
    metaDateOct2025: "14 de outubro de 2025",
    author: "Pesquisado e escrito por: Felipe Gomez @ Notrus AI",
    keywords: [
      "IA atendimento ao cliente",
      "burnout agentes call center",
    ...
    whyItMattersBullets: [
      "Burnout aparece como absenteísmo e rotatividade, ambos caros.",
      "IA de apoio reduz carga cognitiva e acelera aprendizado.",
      "IA focada em vigilância eleva estresse e corrói confiança.",
    ],
    ...
    brRegTitle: "Conclusão: transformando rotatividade em vantagem",
    brRegBody: [
...
export const aiHallucinationsTexts: Record<Language, AIHallucinationsTexts> = {
  en: {
    ...
    s1FigureCaption: "Types of AI hallucinations by [Anh-Hoang et al. (2025)](https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2025.1622292/full). Visuals by Notrus AI.",
    s1Body2: [
    ...
    s2Body: [
      "[Chelli et al. (2024)](https://www.jmir.org/2024/1/e53164/authors) conducted a comparative study across major large language models (LLMs) using three core metrics: precision, recall, and hallucination rate. While their results, showing a 39.6% hallucination rate for GPT-3.5 and a reduced 28.6% for GPT-4, reflect clear progress in factual reliability, these models are now somewhat outdated given the rapid evolution of LLMs. Nonetheless, the findings remain valuable as they illustrate a consistent trend across generations: even advanced models are prone to factual hallucinations, underscoring the ongoing importance of rigorous validation and human oversight in AI-generated content.",
      "Recent literature supports this trend, with most models showing hallucination rates between 25–40%, depending on domain complexity and prompt clarity ([Li et al., 2024;](https://arxiv.org/abs/2401.03205) [Bayat et al., 2024](https://arxiv.org/abs/2410.22257)). While precision and recall continue to improve, the most critical benchmark for business adoption remains the reduction of hallucinations—ensuring AI systems deliver accurate, verifiable insights."
    ],
    s2FigureCaption: "Performance comparison of few LLMs based on hallucination rates. Sources: [Chelli et al., 2024;](https://www.jmir.org/2024/1/e53164/authors) [Yan et al., 2024;](https://arxiv.org/abs/2406.17115) [Tarris & Martin, 2025;](https://journals.sagepub.com/doi/10.1177/20552076241310630) [Erdem et al., 2025;](https://link.springer.com/article/10.1007/s41060-025-00731-0) [Huang et al., 2025](https://dl.acm.org/doi/10.1145/3703155). Visuals by Notrus AI.",
    s2Body2: [
      "Across multiple studies, as shown in the graph above ([Chelli et al., 2024;](https://www.jmir.org/2024/1/e53164/authors) [Yan et al., 2024;](https://arxiv.org/abs/2406.17115) [Tarris & Martin, 2025;](https://journals.sagepub.com/doi/10.1177/20552076241310630) [Erdem et al., 2025;](https://link.springer.com/article/10.1007/s41060-025-00731-0) [Huang et al., 2025](https://dl.acm.org/doi/10.1145/3703155)) GPT-4 consistently outperformed GPT-3.5 and Gemini (Bard) in factual accuracy, averaging 26–28% hallucination rates. This signals a maturing landscape where factual grounding and retrieval mechanisms are increasingly central to enterprise AI reliability."
    ],
    s3Title: "Understanding the Sources: Prompt vs. Model-Based Hallucinations",
    s3Body: [
      "[Anh-Hoang et al. (2025)](https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2025.1622292/full) categorize AI hallucinations into two types: prompt-based and model-internal. Prompt-based hallucinations arise from poorly structured or misleading instructions, which cause the model to misinterpret intent. In contrast, model-internal hallucinations stem from architectural or data limitations within the LLM itself.",
  ...
  pt: {
    ...
    s1FigureCaption: "Tipos de alucinações de IA por [Anh-Hoang et al. (2025)](https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2025.1622292/full). Visualização por Notrus AI.",
    s1Body2: [
    ...
    s2Body: [
      "[Chelli et al. (2024)](https://www.jmir.org/2024/1/e53164/authors) conduziram um estudo comparativo entre os principais grandes modelos de linguagem (LLMs) usando três métricas principais: precisão, recall e taxa de alucinação. Embora seus resultados, mostrando uma taxa de alucinação de 39,6% para GPT-3.5 e uma reduzida de 28,6% para GPT-4, reflitam um progresso claro na confiabilidade factual, esses modelos agora estão um tanto desatualizados dada a rápida evolução dos LLMs. No entanto, as descobertas permanecem valiosas, pois ilustram uma tendência consistente entre gerações: mesmo modelos avançados são propensos a alucinações factuais, ressaltando a importância contínua de validação rigorosa e supervisão humana no conteúdo gerado por IA.",
      "A literatura recente apoia essa tendência, com a maioria dos modelos mostrando taxas de alucinação entre 25–40%, dependendo da complexidade do domínio e clareza do prompt ([Li et al., 2024;](https://arxiv.org/abs/2401.03205) [Bayat et al., 2024](https://arxiv.org/abs/2410.22257)). Embora precisão e recall continuem a melhorar, o benchmark mais crítico para adoção empresarial permanece a redução de alucinações—garantindo que sistemas de IA entreguem insights precisos e verificáveis."
    ],
    s2FigureCaption: "Comparação de desempenho de alguns LLMs baseada em taxas de alucinação. Fontes: [Chelli et al., 2024;](https://www.jmir.org/2024/1/e53164/authors) [Yan et al., 2024;](https://arxiv.org/abs/2406.17115) [Tarris & Martin, 2025;](https://journals.sagepub.com/doi/10.1177/20552076241310630) [Erdem et al., 2025;](https://link.springer.com/article/10.1007/s41060-025-00731-0) [Huang et al., 2025](https://dl.acm.org/doi/10.1145/3703155). Visualização por Notrus AI.",
    s2Body2: [
      "Em múltiplos estudos, como mostrado no gráfico acima ([Chelli et al., 2024;](https://www.jmir.org/2024/1/e53164/authors) [Yan et al., 2024;](https://arxiv.org/abs/2406.17115) [Tarris & Martin, 2025;](https://journals.sagepub.com/doi/10.1177/20552076241310630) [Erdem et al., 2025;](https://link.springer.com/article/10.1007/s41060-025-00731-0) [Huang et al., 2025](https://dl.acm.org/doi/10.1145/3703155)) GPT-4 consistentemente superou GPT-3.5 e Gemini (Bard) em precisão factual, com média de 26–28% de taxas de alucinação. Isso sinaliza um cenário em amadurecimento onde fundamentação factual e mecanismos de recuperação são cada vez mais centrais para a confiabilidade da IA empresarial."
    ],
    s3Title: "Compreendendo as Fontes: Alucinações Baseadas em Prompt vs. Modelo",
    s3Body: [
      "[Anh-Hoang et al. (2025)](https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2025.1622292/full) categorizam alucinações de IA em dois tipos: baseadas em prompt e internas ao modelo. Alucinações baseadas em prompt surgem de instruções mal estruturadas ou enganosas, que fazem o modelo interpretar mal a intenção. Em contraste, alucinações internas ao modelo derivam de limitações arquiteturais ou de dados dentro do próprio LLM.",
