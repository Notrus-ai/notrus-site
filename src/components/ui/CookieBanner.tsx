...
function storeConsent(value: Record<string, boolean>) {
  Cookies.set(
    CONSENT_KEY,
...
function applyConsentToScripts(consent: Record<string, boolean> | null) {
          ...
          <div className="w-full max-w-2xl rounded-xl border border-gray-200 bg-white shadow-2xl">
            <div className="p-6">
              ...
              <div className="mt-4 space-y-4">
                <Category
                  title={text.categories.necessary.label}
                  desc={text.categories.necessary.desc}
                  checked={true}
                  disabled
                />
                <Category
                ...
                <Category
                  ...
                  desc={text.categories.functional.desc}
                  checked={prefs.functional}
                  onChange={(v) => setPrefs((p) => ({ ...p, functional: v }))}
                />
                <Category
                  title={text.categories.marketing.label}
                  desc={text.categories.marketing.desc}
