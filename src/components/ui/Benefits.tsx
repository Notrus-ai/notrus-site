    ...
    <section id={t("benefits")} className="py-20 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-blue-50 to-blue-100 h-72 flex flex-col">
            <CardHeader>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-green-50 to-green-100 h-72 flex flex-col">
            <CardHeader>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-orange-50 to-orange-100 h-72 flex flex-col">
            <CardHeader>
          ...
          {/* new boxes from here */}
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-yellow-50 to-yellow-100 h-72 flex flex-col">
            <CardHeader>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-red-50 to-red-100 h-72 flex flex-col">
            <CardHeader>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow border-0 bg-gradient-to-br from-pink-50 to-pink-100 h-72 flex flex-col">
            <CardHeader>
